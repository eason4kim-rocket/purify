...
> **状态快照**：原交接 waypoint `c7189c2`，当前代码 waypoint `60eff7b`（分支 `codex/search-api-v1`）；P1 N_eff v1 五卡已于 2026-08-11 完成至 `94f9f88`，整块审查补强至 `d213376`；P2 EAV 两张校准卡已完成至 `c60ec5f`，整块审查补强至 `22c379e`，Compose 配置闭合至 `1a2c601`；P3 已完成 R-1 设计定案至 `8c83af3`、R-2 pure rerank core `c8e72f8`、R-3 strict runtime/config `9f837ee` + `c385830`（admission 边界澄清 `9697a3f`、网络审查补强 `e649afc`）、R-4 内部 relevance orchestration `dfc89c7` 与 R-5 relevance 公开契约 `ea7a87e` + `9e83c40` + `dae246d`；R-6 已在 provisional recording/replay/scorecard scaffold 上继续落 blind judgment 与 provider-price evidence 合同至 `60eff7b`，R-6a 已落 local Docker Engine / recording-only session 与 persistent cleanup journal / crash-safe quarantine 至 `ea6d5e1`，但**尚未完成真实 licensed judged corpus、authenticated linux/amd64 NVIDIA recordings、live mount/UDS evidence、完整价格 artifact/scorecard，或 ambiguous `creating` record 的 authenticated completion barrier，因此 R-6/R-6a 均未通过**。Phase 0–8 与 P1/P2 代码均收口；当前晋级的 curated regression replay 成绩为 P=1.000 / R=0.996 / FP=0 / U=0.003 / silent=0、hard R=0.975（完整录制口径与残余见 §15）。
